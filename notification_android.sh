...
# Jenkins配置
JENKINS_BASE_URL="https://jenkins.xdarren.com/job/知鲜阁-Android/"
...
# 失败
# sh notification_android.sh --version "1.0.0" --version_code "100000092" --branch_name "main" --build_id "123" --artifact_path "path/to/artifact" --channel "official" --build_status "failure" --tips "☹️失败推送测试" --environment "test"

# 成功
# sh notification_android.sh --version "1.0.0" --version_code "100000092" --branch_name "main" --build_id "123" --artifact_path "path/to/artifact" --channel "official" --build_status "success" --tips "🏅成功推送测试" --environment "test"