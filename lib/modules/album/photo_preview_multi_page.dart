...
final String _tag = 'PhotoPreviewMultiPage';

/// 相册预览页面-选择多张
class PhotoPreviewMultiPage extends HookConsumerWidget {
  const PhotoPreviewMultiPage({
    super.key,
  ...
  final Function(List<Map<String, dynamic>> resultList)? onSelect;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(() {
      ...
      selItemList.value = selectedAssets;
      // 延迟初始化，确保路由动画流畅
                    ...
                    children: [
                      Text(
                        minSelectCount == maxSelectCount
                            ? t.photoPreviewMulti
                                .selectTitle1(count: minSelectCount)
                            : t.photoPreviewMulti.selectTitle2(
                      ...
                      CustomContainer(
                        onTap: () async {
                          ...
                          for (final asset in selItemList.value) {
                            final File? file =
                                await ImageUtils.getSelectedPicFile(asset);
                            if (file != null) {
                              resultList.add({
                        ...
                        child: Container(
                          ...
                          child: Text(t.photoPreviewMulti.next),
                        ),
                      ),
                    ],
                  ),
              ...
              if (originFile != null && context.mounted) {
                ...
                if (isCurrentlySelected) {
                  ...
                  if (currentSelected.length < maxSelectCount) {
                    ...
                    // 显示提示：不能超过最大选择数量
                    Toast.showMessage(t.photoPreviewMulti
                                ...
                                builder: (context, constraints) {
                                  ...
                                  if (pathEntity.value?.name != null &&
                                    ...
                                    albumTitle = pathEntity.value!.name;
                                      ...
                                      'Recent') {
                                    albumTitle = t.photoPreviewMulti.allPhoto;
                                  }
